...
exports.LAZYID = exports.LazyList = void 0;
...
function LazyMathItemMixin(BaseMathItem) {
    return (function (_super) {
        ...
        function class_1() {
            ...
            _this.lazyTex = false;
            _this.attachSpeech = function (document) {
                var _a;
                if (_this.state() >= MathItem_js_1.STATE.ATTACHSPEECH)
                    return;
                if (!_this.lazyTypeset) {
                    (_a = _super.prototype.attachSpeech) === null || _a === void 0 ? void 0 : _a.call(_this, document);
                }
                _this.state(MathItem_js_1.STATE.ATTACHSPEECH);
            };
            if (!_this.end.node) {
...
function LazyMathDocumentMixin(BaseDocument) {
    ...
    return _a = (function (_super) {
            ...
            function BaseClass() {
                ...
                _this.addStyles(_this.constructor.lazyStyles);
                _this.options.MathItem = LazyMathItemMixin(_this.options.MathItem);
            ...
            BaseClass.prototype.lazyTypesetAll = function () {
                return __awaiter(this, void 0, void 0, function () {
                    var state, _b, _c, item, math, fontCache;
                    var e_2, _d;
                    var _this = this;
                    return __generator(this, function (_e) {
                        state = MathItem_js_1.STATE.LAST;
                        try {
                            for (_b = __values(this.math), _c = _b.next(); !_c.done; _c = _b.next()) {
                                item = _c.value;
                                math = item;
            ...
            BaseClass.prototype.lazyHandleSet = function () {
                ...
                this.lazyPromise = this.lazyPromise.then(function () {
                    var state = _this.compileEarlierItems(set)
                ...
                try {
                    for (var _c = __values(set.values()), _d = _c.next(); !_d.done; _d = _c.next()) {
                        ...
                        if (math.lazyCompile) {
                            ...
                            math.state(MathItem_js_1.STATE.METRICS - 1);
                            state = MathItem_js_1.STATE.METRICS;
                        }
                        else {
                            math.state(MathItem_js_1.STATE.TYPESET - 1);
                        }
        ...
        _a.OPTIONS = __assign(__assign({}, BaseDocument.OPTIONS), { lazyMargin: '500px', lazyAlwaysTypeset: null, renderActions: __assign(__assign({}, BaseDocument.OPTIONS.renderActions), { lazyAlways: [MathItem_js_1.STATE.LAZYALWAYS, 'lazyAlways', '', false] }) }),
        _a.lazyStyles = {
            'mjx-lazy': {
