...
var TexConstants_js_1 = require("./tex/TexConstants.js");
...
var TeX = (function (_super) {
    ...
    function TeX(options) {
        ...
        _this.postFilters.addList([
            [FilterUtil_js_1.default.cleanSubSup, -7],
            [FilterUtil_js_1.default.setInherited, -6],
            [FilterUtil_js_1.default.checkScriptlevel, -5],
            [FilterUtil_js_1.default.moveLimits, -4],
            [FilterUtil_js_1.default.cleanStretchy, -3],
            [FilterUtil_js_1.default.cleanAttributes, -2],
            [FilterUtil_js_1.default.combineRelations, -1],
        ]);
        return _this;
    }
    ...
    TeX.prototype.compile = function (math, document) {
        ...
        var parser;
        try {
            parser = new TexParser_js_1.default(this.latex, { display: math.display, isInner: false }, this.parseOptions);
            node = parser.mml();
        }
        catch (err) {
        ...
        node.attributes.set(TexConstants_js_1.TexConstant.Attr.LATEX, this.latex);
        if (math.display) {
    ...
    TeX.NAME = 'TeX';
    TeX.OPTIONS = __assign(__assign({}, InputJax_js_1.AbstractInputJax.OPTIONS), { FindTeX: null, packages: ['base'], maxBuffer: 5 * 1024, maxTemplateSubtitutions: 10000, mathStyle: 'TeX', formatError: function (jax, err) {
