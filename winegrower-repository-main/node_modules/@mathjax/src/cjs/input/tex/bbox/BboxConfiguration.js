...
new TokenMap_js_1.CommandMap('bbox', { bbox: BboxMethods.BBox });
exports.BboxConfiguration = Configuration_js_1.Configuration.create('bbox', (_a = {},
    _a[HandlerTypes_js_1.ConfigurationType.HANDLER] = (_b = {}, _b[HandlerTypes_js_1.HandlerType.MACRO] = ['bbox'], _b),
    _a));
