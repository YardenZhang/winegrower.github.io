...
var ColumnParser = (function () {
        ...
        this.columnHandler = {
            ...
            '>': function (state) {
                return (state.cstart[state.j] =
                    _this.getBraces(state) + (state.cstart[state.j] || ''));
            },
            '<': function (state) {
                return (state.cend[state.j - 1] =
                    _this.getBraces(state) + (state.cend[state.j - 1] || ''));
            },
            ...
            '{': function (state) { return _this.brace(state); },
    ...
    ColumnParser.prototype.process = function (parser, template, array) {
        ...
        if (template.charAt(0) === '{' && template.slice(-1) === '}') {
            var braced = this.getBraces(state);
    ...
    ColumnParser.prototype.processColumn = function (state, c) {
    ...
    ColumnParser.prototype.brace = function (state) {
        state.i--;
