...
export declare function isStructuralParent(node: Element): boolean;
export declare const LOOP_LIMIT = 10000;
export declare function loopGuard(limit: number, message: string | (() => string)): () => void;
export declare function isDescendant(descendant: Element, node: Element): boolean;
export declare function purgeNodes(nodes: Element[]): Element[];
export declare function ordRow(node: Element): boolean;
...
export declare function meaningfulSpace(node: Element): boolean;
