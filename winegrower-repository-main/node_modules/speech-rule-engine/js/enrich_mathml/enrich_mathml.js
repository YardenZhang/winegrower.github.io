...
function insertNewChild(node, oldChild, newChild) {
    ...
    const guard = loopGuard(LOOP_LIMIT, () => `insertNewChild loop: next=${next === null || next === void 0 ? void 0 : next.tagName} parent=${parent === null || parent === void 0 ? void 0 : parent.tagName}`);
    while (next &&
...
export function createsCycle(node, newChild) {
...
function pathToRoot(node, opt_test) {
    ...
    const path = [node];
    const guard = loopGuard(LOOP_LIMIT, () => { var _a; return `pathToRoot infinite loop at ${node.tagName} parent=${(_a = node.parentNode) === null || _a === void 0 ? void 0 : _a.tagName}`; });
...
export function ascendNewNode(newNode, semantic) {
    ...
    const guard = loopGuard(LOOP_LIMIT, () => { var _a; return `ascendNewNode infinite loop at ${newNode.tagName} parent=${(_a = newNode.parentNode) === null || _a === void 0 ? void 0 : _a.tagName}`; });
