...
class CaseEmbellished extends abstract_enrich_case_js_1.AbstractEnrichCase {
    ...
    getMathml() {
        this.getFenced_();
        this.fencedMml = EnrichMathml.ascendNewNode(EnrichMathml.walkTree(this.fenced), this.fenced);
        this.getFencesMml_();
    ...
    getFencedMml_() {
        ...
        while (sibling && sibling !== this.cfenceMml) {
            ...
            if (SemanticUtil.isDescendant(this.cfenceMml, sibling)) {
                break;
            }
    ...
    specialCase_(semantic, mml) {
        ...
        if (mmlTag === semantic_util_js_1.MMLTAGS.MSUBSUP) {
            if (((_a = semantic.childNodes[0]) === null || _a === void 0 ? void 0 : _a.role) === semantic_meaning_js_1.SemanticRole.SUBSUP) {
