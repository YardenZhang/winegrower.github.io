...
function isSetNode(node) {
    return (isLeftBrace((0, semantic_util_js_1.getEmbellishedInner)(node.contentNodes[0])) &&
        isRightBrace((0, semantic_util_js_1.getEmbellishedInner)(node.contentNodes[1])));
}
