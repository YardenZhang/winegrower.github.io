...
exports.LOOP_LIMIT = exports.MMLTAGS = void 0;
...
exports.isStructuralParent = isStructuralParent;
exports.loopGuard = loopGuard;
exports.isDescendant = isDescendant;
exports.purgeNodes = purgeNodes;
exports.ordRow = ordRow;
...
exports.meaningfulSpace = meaningfulSpace;
...
function isStructuralParent(node) {
    return STRUCTURAL.includes(DomUtil.tagName(node));
}
exports.LOOP_LIMIT = 10000;
function loopGuard(limit, message) {
    let count = 0;
    return () => {
        if (++count > limit) {
            throw new engine_js_1.SREError(typeof message === 'function' ? message() : message);
        }
    };
}
function isDescendant(descendant, node) {
    ...
    const guard = loopGuard(exports.LOOP_LIMIT, 'isDescendant cycle');
...
function hasAncestorIn(node, ancestors) {
